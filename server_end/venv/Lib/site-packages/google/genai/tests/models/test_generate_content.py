...
GEMINI_FLASH_LATEST = 'gemini-3-flash'
GEMINI_FLASH_2_0 = 'gemini-2.0-flash-001'
GEMINI_FLASH_IMAGE_LATEST = 'gemini-3-flash-image'
...
test_table: list[pytest_helper.TestTableItem] = [
    ...
    pytest_helper.TestTableItem(
        ...
        parameters=types._GenerateContentParameters(
            model='gemini-3-flash/../../upload/v1beta/files',
            contents=t.t_contents('What is your name?'),
        ),
...
def test_replicated_voice_config(client):
  with pytest_helper.exception_if_vertex(client, errors.ClientError):
      client.models.generate_content(
          model='gemini-3-flash-preview-tts-voice-replication-rev22-2025-10-28',
          contents=t.t_contents(
              'Produce a speech response saying "Cheese"'
          ),
          config=types.GenerateContentConfig(
