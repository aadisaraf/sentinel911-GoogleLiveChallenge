...
def test_different_model_names(client):
  if client._api_client.vertexai:
    response1 = client.models.count_tokens(
        model='gemini-3-flash', contents=_COUNT_TOKENS_PARAMS.contents
    )
    assert response1
    ...
    response4 = client.models.count_tokens(
        model='projects/vertexsdk/locations/us-central1/publishers/google/models/gemini-3-flash',
        contents=_COUNT_TOKENS_PARAMS.contents,
    )
    assert response4
  else:
    ...
    response2 = client.models.count_tokens(
        model='models/gemini-3-flash', contents=_COUNT_TOKENS_PARAMS.contents
    )
    assert response2
